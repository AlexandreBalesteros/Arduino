...
//* Data: 27/01/18 Versão:1.05
//************************************************************************
//* 1.00 - 29/04/18 - Versão inicial 
//* 1.02 - Simplificação do timer de interrupção para tentar resolver problema de perda de hora
//* 1.03 - Mudança no algoritmo de mensagens - agora a cada 20 minutos - para tentar resolver perdad de hora
//* 1.04 - 16/12/18 - Mudança do RTC, do módulo 1307 para o módulo DS3231, troca da lib
//* 1.05 - 27/01/19 - Redução de Menssagens
//************************************************************************
//* SubMódulos:
//* RTC DS - Lib DS3231.h
...
void setup() 
{
  ...
  //rtc.setDate(23, 06, 2019);   //Define o dia, mes e ano
 ...
 // Mensagem inicio
  ...
  printStringWithShift ("ABA V.5",100);
  delay (2500);
  m.clear(); // Clears the display
